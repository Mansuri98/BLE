...
{
    public string DeviceName = "Cube";
    public string ServiceUUID = "4d7d1106-ee27-40b2-836c-17505c1044e7";
    public string LedUUID = "A9E90001-194C-4523-A473-5FDF36AA4D20";
    public string ButtonUUID = "4d7d1106-ee27-40b2-836c-17505c1044e8";
    ...
    {
        print(bytes);
        Debug.Log("the incoming data  is " + bytes);
        ButtonPositionText.text = ("Not Pushed " + bytes[0]);
        if (bytes[0] == 0x00)
